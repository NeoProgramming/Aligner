#include "AdvancedAligner.h"
#include <QHash>
#include <QSet>

void AdvancedAligner::align(IAlignmentEngine* alignerEngine) 
{
...
QVector<QPair<int, int>> AdvancedAligner::findAnchors() 
{
...
bool AdvancedAligner::verifyAnchor(int sourceIdx, int audioIdx) 
{
